        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={styles.subViewInput}>
                    ...
                    <PasswordInputText placeholder=' input your password' style={{ borderColor: 'black' }}
                        onChangeText={(password) => this.checkPassword(password)}
                    />

                    <Button rounded style={{ marginTop: 20, justifyContent: 'center' }}
                        onPress={() => this.handleLogin()} disabled={this.check(this.state.isMailValid,this.state.isPasswordValid)}
